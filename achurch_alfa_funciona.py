        ...
        match a:
            ...
            case Abstraccion(var, term):
                ...
                if str(var.valor) in used_variables:
                    ...
                    alfa = Abstraccion(Variable(new_var),substitut(term, var, Variable(new_var)))
                    print(getArbol(alfa))
                    return alfa
                else:
                    #print('pruebo')
            ...
            case Applicacion(term1, term2):
                ...
                else : return Applicacion(convert(term1), convert(term2))
    ...
    def convert(a: Arbre) -> Arbre:
        ...
        match a:
            ...
            case Applicacion(term1, term2):
                ...
                else : return convert(term1) or  convert(term2)
