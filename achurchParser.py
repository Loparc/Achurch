...
class achurchParser ( Parser ):
    ...
    class RootContext(ParserRuleContext):
        ...
        def inst(self):
            return self.getTypedRuleContext(achurchParser.InstContext,0)
    ...
    class InstContext(ParserRuleContext):
        ...
        def instruccio(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(achurchParser.InstruccioContext)
            else:
                return self.getTypedRuleContext(achurchParser.InstruccioContext,i)


        def getRuleIndex(self):
            return achurchParser.RULE_inst
    ...
    def inst(self):
        ...
        localctx = achurchParser.InstContext(self, self._ctx, self.state)
    ...
    class InstruccioContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return achurchParser.RULE_instruccio
    ...
    class AssignacioContext(InstruccioContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a achurchParser.InstruccioContext
    ...
    def instruccio(self):
        ...
        localctx = achurchParser.InstruccioContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                localctx = achurchParser.AssignacioContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 16
                ...
                localctx = achurchParser.CalculContext(self, localctx)
    ...
    class LletraContext(TermeContext):
        ...
        def LLETRA(self):
            return self.getToken(achurchParser.LLETRA, 0)
    ...
    class AbstraccioContext(TermeContext):
        ...
        def SIMBOL(self):
            return self.getToken(achurchParser.SIMBOL, 0)
        def terme(self):
            return self.getTypedRuleContext(achurchParser.TermeContext,0)

        def LLETRA(self, i:int=None):
            if i is None:
                return self.getTokens(achurchParser.LLETRA)
            else:
                return self.getToken(achurchParser.LLETRA, i)
    ...
    def terme(self, _p:int=0):
        ...
        try:
            ...
            if token in [3]:
                localctx = achurchParser.ParentesisContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                ...
                _prevctx = localctx
                self.state = 27
                self.match(achurchParser.SIMBOL)
                self.state = 29 
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while True:
                    self.state = 28
                    self.match(achurchParser.LLETRA)
                    self.state = 31 
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    if not (_la==7):
                ...
                self.state = 33
                self.match(achurchParser.T__4)
                self.state = 34
                self.terme(3)
                pass
            elif token in [7]:
                localctx = achurchParser.LletraContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 35
                self.match(achurchParser.LLETRA)
                ...
                localctx = achurchParser.MacroContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 36
                self.match(achurchParser.VAR)
